...
<script>
        ...
        var targetDate = new Date(''); // กำหนดวันที่ตั้งไว้
        ...
        <footer class="bg-glass shadow pt-3">
            <div class="container">
                ...
                <center>
                    ...
                    <small class=" "></i><i class="fa-solid fa-cog fa-spin"></i>&nbsp; OPEN-SHOPHUB.<a href="https://discord.gg/VjG7VChch5" class=""> ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
                </center>
            </div>
            <script>
